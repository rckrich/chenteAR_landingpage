...
function Depa1A() {
  ...
  document.getElementById("areatotal").innerHTML = "58.05 M² Interior";
  ...
  document.getElementById("preciodelista").innerHTML = "$2,465,024"; /*"$2,416,690";*/
  DepaNumber = "Depa1A";
}

function Depa1AOpcionPago1(){
  document.getElementById("enganchetext").innerHTML = "• 30% de Enganche:";
  document.getElementById("precioenganche").innerHTML = "$739,507";
  ...
  document.getElementById("preciocontraentrega").innerHTML = "$1,725,517";
  document.getElementById("preciofinal").innerHTML = "$2,465,024"; /*"$2,223,355";*/
...
function Depa1F() {
  ...
  document.getElementById("areatotal").innerHTML = "58.05 M² Interior <br> 2.25 M² Balcón"
  document.getElementById("amenidades").innerHTML = "1 Recámara, 1 Baño Completo, Cocina, Sala, Comedor, 1 Medio Baño, Área de Lavado, Bodega, 1 Estacionamiento Techado";
  document.getElementById("floorplant").src = "img/1F.png";
  document.getElementById("floorplant2").src = "";
  document.getElementById("preciodelista").innerHTML = "$2,541,223";
  DepaNumber = "Depa1F";
}

function Depa1FOpcionPago1(){   
  document.getElementById("enganchetext").innerHTML = "• 30% de Enganche:";
  document.getElementById("precioenganche").innerHTML = "$762,367";
  document.getElementById("mensualidadestext").innerHTML = "Mensualidades:";
  document.getElementById("preciomensualidades").innerHTML = "-";
  document.getElementById("contraentregatext").innerHTML = "• 70% Saldo (contra entrega):";
  document.getElementById("preciocontraentrega").innerHTML = "$1,778,856";
  document.getElementById("preciofinal").innerHTML = "$2,541,223"; /*"$2,292,083";*/
  document.getElementById("descuento").innerHTML = "-";
}
...
function Depa2C() {
  ...
  document.getElementById("areatotal").innerHTML = "112.47 M² Interior <br> 4.56 M² Balcón"
  ...
  document.getElementById("preciodelista").innerHTML = "$4,565,296"; /*"$4,475,780";*/
  DepaNumber = "Depa2C";
}

function Depa2COpcionPago1(){   
  document.getElementById("enganchetext").innerHTML = "• 30% de Enganche:";
  document.getElementById("precioenganche").innerHTML = "$1,369,589";
  document.getElementById("mensualidadestext").innerHTML = "Mensualidades:";
  document.getElementById("preciomensualidades").innerHTML = "-";
  document.getElementById("contraentregatext").innerHTML = "• 70% Saldo (contra entrega):";
  document.getElementById("preciocontraentrega").innerHTML = "$3,195,707";
  document.getElementById("preciofinal").innerHTML = "$4,565,296";
  document.getElementById("descuento").innerHTML = "-";
}
...
function Depa2D() {
  ...
  document.getElementById("areatotal").innerHTML = "112.47 M² Interior <br> 2.28 M² Balcón"
  document.getElementById("amenidades").innerHTML = "2 Niveles, 3 Recámaras, 3 Baños Completos, Cocina, Sala, Comedor, Área de Lavado, Bodega, 2 Estacionamientos Techados"; 
  document.getElementById("floorplant").src = "img/2D_PB.png";
  document.getElementById("floorplant2").src = "img/2D_PA.png";
  document.getElementById("preciodelista").innerHTML = "$4,515,652"; /*"$4,427,110";*/
  DepaNumber = "Depa2D";
}

function Depa2DOpcionPago1(){   
  document.getElementById("enganchetext").innerHTML = "• 30% de Enganche:";
  document.getElementById("precioenganche").innerHTML = "$1,354,696";
  document.getElementById("mensualidadestext").innerHTML = "Mensualidades:";
  document.getElementById("preciomensualidades").innerHTML = "-";
  document.getElementById("contraentregatext").innerHTML = "• 70% Saldo (contra entrega):";
  document.getElementById("preciocontraentrega").innerHTML = "$3,160,956";
  document.getElementById("preciofinal").innerHTML = "$4,515,652";
  document.getElementById("descuento").innerHTML = "-";
}
...
function Depa2E() {
  ...
  document.getElementById("preciodelista").innerHTML = "$4,587,746"; /*"$4,497,790";*/
  DepaNumber = "Depa2E";
}

function Depa2EOpcionPago1(){   
  document.getElementById("enganchetext").innerHTML = "• 30% de Enganche:";
  document.getElementById("precioenganche").innerHTML = "$1,376,324";
  document.getElementById("mensualidadestext").innerHTML = "Mensualidades:";
  document.getElementById("preciomensualidades").innerHTML = "-";
  document.getElementById("contraentregatext").innerHTML = "• 70% Saldo (contra entrega):";
  document.getElementById("preciocontraentrega").innerHTML = "$3,211,422";
  document.getElementById("preciofinal").innerHTML = "$4,587,746";
  document.getElementById("descuento").innerHTML = "-";
}
...
function Depa2F() {
  ...
  document.getElementById("areatotal").innerHTML = "113.57 M² Interior <br> 4.50 M² Balcón"
  document.getElementById("amenidades").innerHTML = "2 Niveles, 3 Recámaras, 3 Baños Completos, Cocina, Sala, Comedor, Área de Lavado, Bodega, 2 Estacionamientos Techados"; 
  document.getElementById("floorplant").src = "img/2F_PB.png";
  document.getElementById("floorplant2").src = "img/2F_PA.png";
  document.getElementById("preciodelista").innerHTML = "$4,621,895"; /*"$4,531,270";*/
  DepaNumber = "Depa2F";
}

function Depa2FOpcionPago1(){   
  document.getElementById("enganchetext").innerHTML = "• 30% de Enganche:";
  document.getElementById("precioenganche").innerHTML = "$1,386,568";
  document.getElementById("mensualidadestext").innerHTML = "Mensualidades:";
  document.getElementById("preciomensualidades").innerHTML = "-";
  document.getElementById("contraentregatext").innerHTML = "• 70% Saldo (contra entrega):";
  document.getElementById("preciocontraentrega").innerHTML = "$3,235,327";
  document.getElementById("preciofinal").innerHTML = "$4,621,895";
  document.getElementById("descuento").innerHTML = "-";
}
